...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { id: 'analytics', label: 'Analytics', icon: BarChart3, path: '/analytics' },
    {
      ...
      subItems: [
        ...
        { label: 'About Page', path: '/pages/homepage/about' },
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 left-0 z-50 w-64 shadow-2xl border-r border-white/5',
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between px-6 border-b border-white/5">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-black text-white tracking-tight">Pixie<span style={{color:'#a78bfa'}}>Kat</span></span>
            </div>
            <button onClick={onClose} className="lg:hidden p-1 rounded-md hover:bg-white/10 text-gray-400 hover:text-white">
              <X className="w-5 h-5" />
            </button>
          </div>
