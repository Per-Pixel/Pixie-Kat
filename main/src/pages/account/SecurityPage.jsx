...
function SecurityCard({ icon: Icon, title, description, badge, badgeColor, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex w-full items-center justify-between rounded-[22px] border border-white/60 bg-white/80 p-6 text-left shadow-[0_10px_30px_rgba(91,79,118,0.10)] backdrop-blur-sm transition hover:border-[#8b6dff]/40 hover:bg-white hover:shadow-[0_14px_36px_rgba(108,73,255,0.12)]"
    >
      <div className="flex items-center gap-5">
        <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#6c49ff]/10 to-[#8b6dff]/10">
          <Icon className="size-5 text-[#6c49ff]" />
        </div>
        <div>
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-slate-500">Manage how your account is protected.</p>
            </div>
          </div>
          ...
          <div className="rounded-[28px] border border-white/70 bg-white/80 p-6 shadow-[0_18px_50px_rgba(91,79,118,0.14)] backdrop-blur-xl">
            <div className="mb-5 flex items-center gap-3">
              <Clock className="size-5 text-[#6c49ff]" />
            ...
            {loading ? (
              ...
              <div className="py-8 text-center text-sm text-slate-400">No login history yet.</div>
            ) : (
              <div className="space-y-3">
